...
def translate_html(html_content, lang, translations, filename="index.html"):
    ...
    if filename == "index.html" and lang == "pl":
        pl_business_schema = {
            ...
            "description": "Wycieczki na quadach na Teneryfie do Parku Narodowego Teide. Quady 550cc XL, kameralne grupy do 3 quadów, trasy powyżej 2000 m n.p.m. Wyjazdy poranne i o zachodzie słońca z Las Américas.",
        ...
        es_business_schema = {
            ...
            "@type": "TouristAttraction",
            "name": "Prime Quads Tenerife",
            "description": "Excursiones en quad al Parque Nacional del Teide en Tenerife. Quads de 550cc XL, grupos reducidos de máximo 3 quads, rutas a más de 2000 m. Salidas por la mañana y al atardecer desde Las Américas.",
